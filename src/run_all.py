...
STEPS = [
    ...
    ("eval/zero_shot.py", "Zero-shot FM evaluation (Chronos-2, Chronos-T5 Small/Base, Moirai-2.0-Small) - 4 models reported in paper"),
    ("eval/baselines.py", "Classical baseline models (Persistence, XGBoost, LSTM)"),
    ("finetune/chronos_ft.py", "Fine-tune Chronos-T5 Small and Base on the train split"),
    ("finetune/ttm_ft.py", "Fine-tune TTM-R2 (excluded from paper; kept for future work)"),
